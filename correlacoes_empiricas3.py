...
def f_empiricas(P,T, rho0, API, Vgas, F, dp, eps_B):             # imput ==> P em MPa , T em K ,  desnidade do óleo rhoL em g/cm³, API,  vazão do gás em NL/h, cm³/s vazao de carga ; 0,141mL/s, cm diâmetro da partícula, porosidade do leito
    ...
    resultados[0], resultados[1], resultados[2]=  HH2, HH2S, HNH3
    ...
    resultados[3], resultados[4] = uG, uL
    ...
    resultados[5], resultados[6], resultados[7] = k_L_H2al, k_L_H2Sal, k_L_NH3al 
    ...
    resultados[9], resultados[10], resultados[11], resultados[12], resultados[13] =  k_s_H2, k_s_H2S,  k_s_NH3, k_s_s, k_s_N
